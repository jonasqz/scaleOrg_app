          ...
          <div className="mb-3 flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              {affectedEmployees.filter(e => e.action === 'remove').length > 0 && (
                <span className="rounded-full bg-red-100 px-3 py-1 text-[10px] font-medium text-red-700">
              ...
              {onViewEmployees && (
                <button
                  ...
                  className="ml-2 rounded-lg border border-stone-200 bg-white px-3 py-1 text-[10px] font-medium text-orange-600 transition-colors hover:bg-orange-50"
                >
                  View Employee Table
                </button>
              )}
                  ...
                  <div className="flex-1">
                    <div className="flex items-center gap-2">
                      ...
                      <p className="font-medium text-stone-900">
                        ...
                        {emp.isNew && (
                          <span className="ml-2 rounded bg-green-600 px-2 py-0.5 text-[10px] text-white">
                            New Hire
                          </span>
                        )}
                      </p>
        ...
        <div className="rounded-lg border border-stone-200 bg-white p-4">
          ...
          <div className="overflow-x-auto">
            <table className="w-full">
              <thead>
                <tr className="border-b border-stone-200 bg-stone-50 text-left text-[10px] uppercase tracking-wider text-stone-600">
              ...
              <tbody>
                {monthlyBurnRate.slice(0, 12).map((month) => (
                  <tr key={month.month} className="border-b border-stone-200 text-xs hover:bg-stone-50">
        ...
        <div className="rounded-lg border border-stone-200 bg-white p-4">
          ...
          <div className="grid gap-4 md:grid-cols-3">
            <div className="rounded-lg border border-stone-200 bg-stone-50 p-4">
              <p className="mb-2 text-xs text-stone-600">Current Cash</p>
            ...
            <div className="rounded-lg border border-stone-200 bg-orange-50 p-4">
              <p className="mb-2 text-xs text-stone-600">Baseline Runway</p>
              <p className="text-xl font-bold text-stone-900">
            ...
            <div className="rounded-lg border border-stone-200 bg-green-50 p-4">
              <p className="mb-2 text-xs text-stone-600">Scenario Runway</p>
      ...
      {yearEndProjection && (
        <div className="rounded-lg border border-stone-200 bg-orange-50 p-4">
          ...
          <div className="grid gap-4 md:grid-cols-4">
            <div>
              <p className="text-xs text-orange-700">Baseline Total</p>
            ...
            <div>
              <p className="text-xs text-orange-700">Scenario Total</p>
              <p className="mt-1 text-xl font-bold text-orange-900">
            ...
            <div>
              <p className="text-xs text-orange-700">Total Savings</p>
            ...
            <div>
              <p className="text-xs text-orange-700">Avg Monthly Burn</p>
              <p className="mt-1 text-xl font-bold text-orange-900">
