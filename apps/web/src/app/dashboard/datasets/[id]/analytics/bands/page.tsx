...
export default async function AnalyticsBandsPage({ params }: PageProps) {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-stone-900">Bands & Benchmarking</h1>
        <p className="text-sm text-stone-600 mt-1">
          Department and role distribution with industry benchmarks
        </p>
      </div>
