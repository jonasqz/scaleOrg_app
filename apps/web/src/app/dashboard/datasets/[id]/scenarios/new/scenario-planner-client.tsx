  ...
  return (
    <div className="space-y-6">
      ...
      <div className="rounded-lg border border-stone-200 bg-white p-4">
        <h2 className="mb-4 text-sm font-semibold text-stone-900">Scenario Information</h2>
        <div className="space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full rounded-lg border border-stone-200 px-4 py-2 text-xs focus:border-orange-500 focus:outline-none focus:ring-1 focus:ring-orange-500"
            />
          </div>
          <div>
            <label className="block text-xs font-medium text-stone-700 mb-1">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full rounded-lg border border-stone-200 px-4 py-2 pl-12 text-xs focus:border-orange-500 focus:outline-none focus:ring-1 focus:ring-orange-500"
              />
            </div>
          </div>
      ...
      {result && (
        <div className="space-y-6">
          <div className="rounded-lg border border-stone-200 bg-orange-50 p-4">
            <h3 className="text-xs font-semibold text-orange-900">Scenario Results</h3>
            <p className="mt-1 text-[10px] text-orange-700">Analysis complete - review and save</p>
          </div>
